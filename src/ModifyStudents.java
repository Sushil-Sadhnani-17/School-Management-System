...
public class ModifyStudents extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(70, 200, 91, 33);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int responce=JOptionPane.showConfirmDialog(this,"Do You Really Want To Modify?");
        if(responce==0)
        {   try {Class.forName("java.sql.Driver");
            ...
            String modify="update students set Name='"+b+"' where Roll_no="+a;
            int check = stmt.executeUpdate(modify);
            con.close();
            if(check==0)
        {JOptionPane.showMessageDialog(this,"Student Not Found.");}
        else
            JOptionPane.showMessageDialog(this,check+" Student Modified Successfully");
...
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifyStudents.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
